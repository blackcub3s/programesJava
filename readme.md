...
_Crear un programa per a gestionar les notes d'un grup escolar (amb un grup de 20 alumnes i tres assignatures) que permeti:_

_- Introduir les notes._
_- Calcular la nota mitjana de cada alumne._
_- Calcular la màxima nota de cada assignatura o mòdul._
_- Calcular la nota mitjana per mòdul i quants alumnes la sobrepassen._

La resolució la tenim dins el fitxer [Exerciic5.java](./U06_Matrius/Exercici5.java)._
